...
<main>
  ...
  <nav class="tabs" role="tablist">
    <button class="tab active" data-tab="politics">${CATEGORY_LABELS.politics}<span class="count">${counts.politics}</span></button>
  ...
  <section class="panel active" data-panel="politics">
